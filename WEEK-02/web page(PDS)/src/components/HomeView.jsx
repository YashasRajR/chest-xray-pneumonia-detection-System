...
export default function HomeView({ user, setActiveTab, roleMode }) {
  ...
  return (
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '20px', height: '100%', justifyContent: 'space-between' }}>
      ...
      {/* Welcome Banner */}
      <div className="glass-panel" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '8px', background: 'linear-gradient(135deg, rgba(2, 195, 154, 0.04), rgba(5, 102, 141, 0.04))' }}>
